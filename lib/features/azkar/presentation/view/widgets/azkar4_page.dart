...
class AzkarPage4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('أذكار الاستيقاظ',style: TextStyle(fontWeight: FontWeight.bold , color: Colors.white),),
        centerTitle: true,
      ...
      body: Container(
        ...
        child: BlocProvider(
          create: (context) => AzkarCubit()..fetchAzkar4(),
